...
public class GetRequest07 extends JsonPlaceHolderBaseUrl {
    ...
    public void get01(){
        ...
        // findAll{it.id>t190} ====> Tells to Groovy to look at the json data under the condition id>190
        // .id ===> Tells the Groovy to select what. yazdirilmak istenen parametre
